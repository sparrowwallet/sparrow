...
public class TimelockRecovery {
    ...
    public static WalletNode reserveInitiationNode(Wallet wallet) {
        WalletNode initiationNode = labeledOrFreshChangeNode(wallet, INITIATION_ADDRESS_LABEL, null);
    ...
    public static WalletNode reserveCancellationNode(Wallet wallet, WalletNode after) {
        WalletNode cancellationNode = labeledOrFreshChangeNode(wallet, CANCELLATION_ADDRESS_LABEL, after);
        cancellationNode.setLabel(CANCELLATION_ADDRESS_LABEL);
        return cancellationNode;
    }

    static WalletNode labeledOrFreshChangeNode(Wallet wallet, String label, WalletNode after) {
        WalletNode purposeNode = wallet.getNode(KeyPurpose.CHANGE);
        ...
        while(true) {
            WalletNode candidate = wallet.getFreshNode(KeyPurpose.CHANGE, previous);
